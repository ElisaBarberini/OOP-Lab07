...
public final class TestSportByEnumeration {
    ...
    public static void main(final String... args) {
         ...
         */
        // TODO
    	final SportSocialNetworkUserImpl<User> dcassani = new SportSocialNetworkUserImpl("Davide" , "Cassani" , "dacassani" , 53);
        final SportSocialNetworkUserImpl<User> becclestone = new SportSocialNetworkUserImpl("Bernie" , "Ecclestone" , "becclestone" , 83);
        final SportSocialNetworkUserImpl<User> falonso = new SportSocialNetworkUserImpl("Fernando" , "Alonso" , "falsonso" ,34);
